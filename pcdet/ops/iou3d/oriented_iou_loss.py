...
def cal_diou_3d(box3d1:torch.Tensor, box3d2:torch.Tensor, enclosing_type:str="smallest", return_dist= False):
    ...
    c2 = w*w + h*h + z_range*z_range + 1e-6
    diou = 1. - iou3d + d2/c2
    if return_dist:
        return diou, iou3d, d2/c2
    else:
        return diou, iou3d
